...
function parseTableWithDom(document) {
  ...
  return buildResult(totalHours, rowCount, invalidHourCount, invalidHourSamples, attendanceDates);
}
...
function buildResult(totalHours, rowCount, invalidHourCount, invalidHourSamples, attendanceDates) {
  const result = {
