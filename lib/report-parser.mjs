...
function parseTableWithDom(document) {
  ...
  return buildResult(totalHours, rowCount, invalidHourCount, invalidHourSamples);
}
...
function buildResult(totalHours, rowCount, invalidHourCount, invalidHourSamples) {
  const result = {
